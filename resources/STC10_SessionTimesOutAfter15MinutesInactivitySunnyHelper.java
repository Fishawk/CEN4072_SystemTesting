...
/**
 * Script Name   : <b>STC10_SessionTimesOutAfter15MinutesInactivitySunny</b><br>
 * Generated     : <b>2015/10/19 4:12:00 PM</b><br>
 ...
 * @author Princ_000
 */
public abstract class STC10_SessionTimesOutAfter15MinutesInactivitySunnyHelper extends RationalTestScript
{
	/**
	 ...
	 *		.text : Home
	 * 		.href : http://localhost:8080/International_Science_Consortium/
	 * 		.id : 
	 * 		.title : 
	 * 		.class : Html.A
	 * 		.name : 
	 * 		.classIndex : 0
	 */
	protected GuiTestObject link_home() 
	{
		return new GuiTestObject(
	 ...
	 * 		.classIndex : 0
	 */
	protected GuiTestObject link_home(TestObject anchor, long flags) 
	{
		return new GuiTestObject(
	 ...
	 * 		.classIndex : 3
	 */
	protected StatelessGuiSubitemTestObject table_htmlTable_3() 
	{
		return new StatelessGuiSubitemTestObject(
                        getMappedTestObject("table_htmlTable_3"));
	}
	/**
	 ...
	 * 		.classIndex : 3
	 */
	protected StatelessGuiSubitemTestObject table_htmlTable_3(TestObject anchor, long flags) 
	{
		return new StatelessGuiSubitemTestObject(
                        getMappedTestObject("table_htmlTable_3"), anchor, flags);
	}
	...
	/**
	 * Locate and return the verification point HtmlTable_2_grid object in the SUT.
	 */
	protected IFtVerificationPoint HtmlTable_2_gridVP() 
	{
		return vp("HtmlTable_2_grid");
	}
	protected IFtVerificationPoint HtmlTable_2_gridVP(TestObject anchor)
	{
		return vp("HtmlTable_2_grid", anchor);
	}
	
	

	protected STC10_SessionTimesOutAfter15MinutesInactivitySunnyHelper()
	{
		setScriptName("STC10_SessionTimesOutAfter15MinutesInactivitySunny");
	}
