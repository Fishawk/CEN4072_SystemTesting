...
/**
 * Script Name   : <b>STC08_ViewPanelInformationRainy</b><br>
 * Generated     : <b>2015/10/19 4:17:00 PM</b><br>
 ...
 * @author Princ_000
 */
public abstract class STC08_ViewPanelInformationRainyHelper extends RationalTestScript
{
	/**
	...
	/**
	 * ThisPageCanTBeDisplayed: with default state.
	 *		.title : This page can’t be displayed
	 * 		.class : Html.HtmlDocument
	 * 		.url : res://ieframe.dll/dnserror.htm#http://localhost:8080/International_Science_Conso ...
	 */
	protected DocumentTestObject document_thisPageCanTBeDisplay() 
	{
		return new DocumentTestObject(
                        getMappedTestObject("document_thisPageCanTBeDisplay"));
	}
	/**
	 * ThisPageCanTBeDisplayed: with specific test context and state.
	 *		.title : This page can’t be displayed
	 * 		.class : Html.HtmlDocument
	 * 		.url : res://ieframe.dll/dnserror.htm#http://localhost:8080/International_Science_Conso ...
	 */
	protected DocumentTestObject document_thisPageCanTBeDisplay(TestObject anchor, long flags) 
	{
		return new DocumentTestObject(
                        getMappedTestObject("document_thisPageCanTBeDisplay"), anchor, flags);
	}
	...
	protected STC08_ViewPanelInformationRainyHelper()
	{
		setScriptName("STC08_ViewPanelInformationRainy");
	}
