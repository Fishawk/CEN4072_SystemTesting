...
import resources.STC10_SessionTimesOutAfter15MinutesInactivityRainy01Helper;
 ...
 * @author Princ_000
 */
public class STC10_SessionTimesOutAfter15MinutesInactivityRainy01 extends STC10_SessionTimesOutAfter15MinutesInactivityRainy01Helper
{
	/**
	 * Script Name   : <b>Script1</b>
	 * Generated     : <b>Oct 19, 2015 12:21:09 PM</b>
	 * Description   : Functional Test Script
	...
	public void testMain(Object[] args) 
	{
		...
		text_username().click(atPoint(16,12));
		browser_htmlBrowser(document_iscControlSystem(),DEFAULT_FLAGS).inputChars("admin");
		text_password().click(atPoint(6,10));
		browser_htmlBrowser(document_iscControlSystem(),DEFAULT_FLAGS).inputChars("admin");
